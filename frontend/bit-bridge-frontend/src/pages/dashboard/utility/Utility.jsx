...
const Utility = () => {
  ...
  const serviceCards = useMemo(() => {
    const catalogCards = BRIDGE_UTILITY_CARD_TYPES.map((serviceType) => {
    ...
    return [
      ...catalogCards,
      {
        key: 'BETTING',
        title: 'Betting',
        description: 'Open Monnify-backed betting billers and submit wallet-funded betting payments.',
        to: '/dashboard/utilities/betting',
        icon: SERVICE_ICONS.BETTING,
        accent: 'from-emerald-500/20 via-cyan-500/10 to-slate-900',
        border: 'border-emerald-500/25',
        iconWrap: 'bg-emerald-500/15 text-emerald-300',
        button: 'text-emerald-200',
        preview: ['Bet9ja', 'BetWay', 'SportyBet', 'MSport'],
        available: true,
      },
    ]
  }, [catalogItems])
